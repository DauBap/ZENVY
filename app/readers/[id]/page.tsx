...
export default function ReaderProfilePage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      ...
                      <div className="flex items-center justify-center sm:justify-start gap-4 mb-4">
                        <StarRating rating={reader.rating} showValue size="md" />
                ...
                <GlassCard className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-lg font-semibold text-foreground">
                      Đánh giá ({reader.reviews.length})
                    </h2>
                    <div className="flex items-center gap-2">
                      <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                      <span className="font-semibold text-foreground">{reader.rating}</span>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              >
                <GlassCard className="p-6" glow="purple">
                  ...
                  <Link href={selectedPackage ? `/booking/${reader.id}?package=${selectedPackage}` : '#'}>
                    <Button
                      className={cn(
                        'w-full h-12',
